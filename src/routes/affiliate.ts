...
import { affiliateMetrics, affiliateSettings, attachReferralToUser, emitAffiliateEvent } from "../services/affiliateService";
...
router.post("/track", async (req, res) => {
  ...
  await emitAffiliateEvent("REFERRAL_CLICKED", String(affiliate._id), { referral_id: String(referral._id), referral_click_id: referralClickId });
